                        ...
                        <div class="card">
                            <div class="card-body overflow-hidden">
                                <div class="d-flex justify-content-between mb-3"> 
                                    <h4 class="card-title mt-1">Appointment Requests ( Completed Requests )</h4>
                                </div>
                                    ...
                                    <table id="file_export" class="table table-bordered display w-100">
                                            ...
                                            <tbody>
                                            <?php include('../backend/fetch_completed.php'); ?>
                                                    ...
                                                    echo 
                                                        '<div class="d-flex align-items-center justify-content-center p-1">
                                                            <span class="">
                                                                ...
                                                                .($record['status'] == 'pending' ? 'badge-warning' : ($record['status'] == 'approved' ? 'badge-primary' : ($record['status'] == 'completed' ? 'badge-success' : 'badge-danger'))).
